               ...
               while (true) 
               {
                 ...
                 mark = sc.nextInt();
                   ...
                   else 
                   {
                    ...
                    {
                      System.out.println("\nStatus: Pass with Outstanding Performance!");
                      System.out.println("Remarks: We wish you a bright future");
                    }
                    else if(per >= 80)
                    {
                     System.out.println("\nStatus: Pass with Brilliant Performance!");
                     System.out.println("Remarks: We wish you a bright future"); 
                    }
                    else if(per >= 70)
                    {
                     System.out.println("\nStatus: Pass with Honorable Performance!"); 
                     System.out.println("Remarks: We wish you a bright future");
                    }
                    else if(per >= 60)
                    {
                     System.out.println("\nStatus: Pass with Good Performance!"); 
                     System.out.println("Remarks: We wish you a bright future");
                    }
                    else if(per >= 50)
                    {
                     System.out.println("\nStatus: Pass with Average Performance!");
                     System.out.println("Remarks: We wish you a bright future"); 
                    }
                    else if(per >= 40)
                    {
                     System.out.println("\nStatus: Pass with Below Average Performance!");
                     System.out.println("Remarks: We wish you a bright future"); 
                    }

                    System.out.println("\nDo you want to add more student's details ? (yes/no)");
                    choice = sc.nextLine();
